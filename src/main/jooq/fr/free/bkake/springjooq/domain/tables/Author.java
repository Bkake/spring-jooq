...
import fr.free.bkake.springjooq.converter.LocalDateConverter;
...
public class Author extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -1130116493;
     ...
     */
    public final TableField<Record, LocalDate> DATE_OF_BIRTH = createField("DATE_OF_BIRTH", org.jooq.impl.SQLDataType.DATE, this, "", new LocalDateConverter());
